...
class Book < ActiveRecord::Base
  ...
  LEVELS_CONVERT = {
    "A" => [LEVELS_DICT["A"]].to_set,
    "B" => [LEVELS_DICT["B"]].to_set,
    "C" => [LEVELS_DICT["C"]].to_set,
    "D" => [LEVELS_DICT["D"]].to_set,
    "E" => [LEVELS_DICT["E"]].to_set,
    "F" => [LEVELS_DICT["F"]].to_set,
    "Primary 1" => [LEVELS_DICT["A"]].to_set,
    "Standard 1" => [LEVELS_DICT["A"]].to_set,
    "Primary 2" => [LEVELS_DICT["A"], LEVELS_DICT["B"]].to_set,
    "Standard 2" => [LEVELS_DICT["A"], LEVELS_DICT["B"]].to_set,
    "Primary 3" => [LEVELS_DICT["B"]].to_set,
    "Standard 3" => [LEVELS_DICT["B"]].to_set,
    "Primary 4" => [LEVELS_DICT["B"], LEVELS_DICT["C"]].to_set,
    "Standard 4" => [LEVELS_DICT["B"], LEVELS_DICT["C"]].to_set,
    "Primary 5" => [LEVELS_DICT["C"]].to_set,
    "Standard 5" => [LEVELS_DICT["C"]].to_set,
    "Primary 6" => [LEVELS_DICT["C"]].to_set,
    "Standard 6" => [LEVELS_DICT["C"]].to_set,
    "Primary 7" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "Standard 7" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "Primary 8" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "Standard 8" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "JHS 1" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "JHS 2" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "JHS 3" => [LEVELS_DICT["D"]].to_set,
    "SHS 1" => [LEVELS_DICT["D"], LEVELS_DICT["E"]].to_set,
    "SHS 2" => [LEVELS_DICT["E"], LEVELS_DICT["F"]].to_set,
    "SHS 3" => [LEVELS_DICT["E"], LEVELS_DICT["F"]].to_set,
    "Form 1" => [LEVELS_DICT["D"]].to_set,
    "Form 2" => [LEVELS_DICT["D"], LEVELS_DICT["E"]].to_set,
    "Form 3" => [LEVELS_DICT["E"], LEVELS_DICT["F"]].to_set,
    "Form 4" => [LEVELS_DICT["E"], LEVELS_DICT["F"]].to_set,
    "Primary" => [LEVELS_DICT["A"], LEVELS_DICT["B"], LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "Junior High School" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "Secondary" => [LEVELS_DICT["D"], LEVELS_DICT["E"], LEVELS_DICT["F"]].to_set,
    "Beginning Readers" => [LEVELS_DICT["A"], LEVELS_DICT["B"]].to_set,
    "Chapter Books" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set,
    "Young Adult" => [LEVELS_DICT["E"], LEVELS_DICT["F"]].to_set,
    "Adult" => [LEVELS_DICT["F"]].to_set,
    "Lower Primary" => [LEVELS_DICT["A"], LEVELS_DICT["B"]].to_set,
    "Upper Primary" => [LEVELS_DICT["C"], LEVELS_DICT["D"]].to_set
  }
